...
#define nrn_init _nrn_init__cabalan
#define _nrn_initial _nrn_initial__cabalan
#define nrn_cur _nrn_cur__cabalan
#define _nrn_current _nrn_current__cabalan
#define nrn_jacob _nrn_jacob__cabalan
#define nrn_state _nrn_state__cabalan
#define _net_receive _net_receive__cabalan 
#define state state__cabalan 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "fCa_cabalan", "1",
 "cainit_cabalan", "mM",
 "icapumpmax_cabalan", "mA/cm2",
 "km_cabalan", "mM",
 "icapump_cabalan", "mA/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 cabalan /mnt/c/Users/lawre/OneDrive/Documents/burise/VTA-neurons-opiates-withdrawal/EnricoEtAl2016/cabal.mod\n");
...
_MATELM1(0, 0) *= ( PI * diam * diam / 4.0);  }
 icapump = icapumpmax * ( 1.0 / ( 1.0 + km / cai ) ) ;
   /* COMPARTMENT PI * diam * diam / 4.0 {
     cai }
   */
 /* ~ cai < < ( - fCa * ( ica + icapump ) * PI * diam * ( 1e4 ) / ( 2.0 * FARADAY ) )*/
 f_flux = b_flux = 0.;
 _RHS1( 0) += (b_flux =   ( - fCa * ( ica + icapump ) * PI * diam * ( 1e4 ) / ( 2.0 * FARADAY ) ) );
 /*FLUX*/
    } return _reset;
 }
 ...
 */
 /* ~ cai < < ( - fCa * ( ica + icapump ) * PI * diam * ( 1e4 ) / ( 2.0 * FARADAY ) )*/
 f_flux = b_flux = 0.;
 Dcai += (b_flux =   ( - fCa * ( ica + icapump ) * PI * diam * ( 1e4 ) / ( 2.0 * FARADAY ) ) );
 /*FLUX*/
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/c/Users/lawre/OneDrive/Documents/burise/VTA-neurons-opiates-withdrawal/EnricoEtAl2016/cabal.mod";
static const char* nmodl_file_text = 
