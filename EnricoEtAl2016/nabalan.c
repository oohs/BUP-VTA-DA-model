...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 nabalan C:/Users/lawre/OneDrive/Documents/burise/VTA-neurons-opiates-withdrawal/EnricoEtAl2016/nabalan.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "nabalan.mod";
static const char* nmodl_file_text = 
